...
export const ROUTES: RouteInfo[] = [
     ...
     { path: '', title: 'Role Management ', icon: 'ft-user', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, 
      submenu: [
         { path: '/role/createrole', title: 'Create Role', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },

         { path: '/role/webrole', title: 'Web Role', icon: ''  , class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
         { path: '/role/kioskrole', title: 'Kiosk Role', icon: ''  , class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
